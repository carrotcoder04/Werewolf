...
public class Description {
    public static final String SEER = "Mỗi đêm bạn có thể xem vai trò của người chơi khác.";
    public static final String MAYOR = "Một lần trong trò chơi, bạn có thể tiết lộ vai trò của mình, điều này sẽ khiến số phiếu bầu của bạn tăng gấp đôi trong suốt phần còn lại của trò chơi.";
    public static final String MEDIUM = "Vào buổi đêm bạn có thể trò chuyện ẩn danh với người chết. Bạn có khả năng chọn một dân làng đã chết trong đêm và hồi sinh họ vào ban ngày một lần trong ván đấu.";
    public static final String PRIEST = "Bạn có thể vẩy nước thánh lên người chơi khác. Nếu đó là ma sói thì người đó chết, nếu không phải ma sói, bạn chết.";
    ...
    public static final String FOOL = "Bạn phải lừa dân làng treo cổ bạn. Nếu họ treo cổ bạn, bạn thắng.";
    public static final String CORRUPTOR = "Mỗi đêm, bạn có thể chọn một người chơi để \"xâm nhập\". Người chơi đó sẽ không thể sử dụng khả năng vai trò của họ, cũng không thể nói hoặc bỏ phiếu vào ngày hôm sau và sẽ chết vào cuối ngày. Vai trò của họ sẽ không được tiết lộ khi chết. Người chơi đó không thể hồi sinh bởi Thầy Đồng.";
    public static final String ARSONIST = "Vào ban đêm, bạn có thể chọn hai người chơi để tẩm xăng hoặc thiêu chết tất cả những người chơi bị tẩm trước đó. Việc tẩm xăng sẽ xuyên qua lớp bảo vệ.";
}
